      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          {loadingConvos ? (
            ...
            convos.map((c) => (
              <div key={c.chatId} className="flex items-start justify-between">
                <div className="flex items-center space-x-3">
                  <img
                    src={c.participant.avatar || "/profile/default-profile.png"}
                    alt={c.participant.name}
                    className="w-14 h-14 rounded-2xl object-cover"
                  />
                  <div>
                    <h3 className="font-medium">{c.participant.name}</h3>
  ...
  const Projects = (
    ...
    >
      ...
      {loadingProjects ? (
        ...
        <div className="flex justify-center py-8">No Projects found.</div>
      ) : (
