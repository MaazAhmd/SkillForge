        ...
        <div className="max-w-6xl mx-auto bg-gray-100 rounded-xl p-4 md:p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="mt-6">
              <button
                ...
                className="bg-primary hover:brightness-90 text-white px-6 py-2 rounded-md text-sm font-medium flex items-center gap-2 disabled:opacity-50 cursor-pointer"
              >
                {isSubmitting ? (
                  <>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold mb-4">
              Quick Tips for Posting a Project
            </h3>
            <ul className="text-sm text-gray-700 space-y-3 list-decimal list-inside">
              <li>
                ...
                <ul className="list-disc list-inside ml-4 text-gray-600">
                  <li>
                    Keep it short, specific, and clearly describe the type of
                    work.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className="list-disc list-inside ml-4 text-gray-600">
                  <li>
                    Explain what needs to be done, outcomes, and technical
                    needs.
                  </li>
